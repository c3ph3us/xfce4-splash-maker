...
{
  config->name        = g_strdup (_("THEME_NAME"));        // Theme Name
  config->description = g_strdup (_("THEME_DESCRIPTION")); // Description
  config->version     = g_strdup ("VERSION");              // Version
  config->author      = g_strdup ("AUTHOR NAME");          // Author Name
  config->homepage    = g_strdup ("WEBSITE");              // Website
